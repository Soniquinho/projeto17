...
function preload(){
  ...
  deadManImg = loadAnimation("dead-man.png");
...
boy.addAnimation("SahilDying", deadManImg);
boy.scale=0.08;

//sprite da tela de morte
endScreen = createSprite(200,300,10,10);
...
function draw() {
  ...
  //invisibilidade da tela de morte
...
//Mude o gameState (estado do jogo) para End
 ...
 //animação de morte
 boy.changeAnimation("SahilDying", deadManImg);
